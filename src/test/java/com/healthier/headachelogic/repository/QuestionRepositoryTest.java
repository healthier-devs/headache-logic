...
class QuestionRepositoryTest {
    ...
    void findByPainSite() {
        ...
        //when
        Optional<Question> question1 = questionRepository.findByPainSiteContainsAndIsFirst(painSite1, true);
        Optional<Question> question2 = questionRepository.findByPainSiteContainsAndIsFirst(painSite2, true);
